...
An experimental bridge that connects **Dragon Quest IX local wireless** between an iPhone build of Delta and the official melonDS 1.1 LAN host on macOS.
...
- ENet: `1.3.18`
- LAN host: official melonDS `1.1` for macOS
